export const scriptData = {
  INICIO: {
    category: "Inicio",
    messages:
      "Hola, soy [Nombre] de la Universidad Americana. ¿En qué puedo ayudarte hoy?",
    options: [
  ...
  SOLICITUD_INFO: {
    ...
    messages: [
      "Te paso todos los costos y también cómo sería la modalidad de estudio para que puedas tener mayor conocimiento.",
